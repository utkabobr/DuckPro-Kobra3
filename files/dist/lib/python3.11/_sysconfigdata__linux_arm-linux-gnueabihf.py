...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/home/ytka/dist/bin',
 'BINLIBDEST': '/home/ytka/dist/lib/python3.11',
 'BLDLIBRARY': 'libpython3.11.a',
 'BLDSHARED': 'arm-rockchip830-linux-uclibcgnueabihf-gcc -shared '
              '-L/home/ytka/dist/lib',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CONFIGURE_CFLAGS_NODIST': '-fno-semantic-interposition -flto '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '-I/home/ytka/dist/include '
                       '-I/home/ytka/dist/include/uuid '
                       '-I/home/ytka/dist/include/openssl '
                       '-L/home/ytka/dist/lib',
 'CONFIGURE_LDFLAGS': '-L/home/ytka/dist/lib',
 'CONFIGURE_LDFLAGS_NODIST': '-fno-semantic-interposition -flto '
                             '-fuse-linker-plugin -ffat-lto-objects '
                             '-flto-partition=none -g',
 'CONFIGURE_LDFLAGS_NOLTO': '-fno-lto',
 'CONFIG_ARGS': "'--host=arm-rockchip830-linux-uclibcgnueabihf' "
                "'--build=x86_64' '--with-build-python=python3.11' "
                "'--disable-ipv6' '--enable-optimizations' '--with-lto' "
                "'--prefix=/home/ytka/dist/' '--with-openssl=/home/ytka/dist/' "
                "'build_alias=x86_64' "
                "'host_alias=arm-rockchip830-linux-uclibcgnueabihf' "
                "'LDFLAGS=-L/home/ytka/dist/lib' "
                "'CPPFLAGS=-I/home/ytka/dist/include "
                '-I/home/ytka/dist/include/uuid '
                "-I/home/ytka/dist/include/openssl -L/home/ytka/dist/lib'",
 'CONFINCLUDEDIR': '/home/ytka/dist/include',
 'CONFINCLUDEPY': '/home/ytka/dist/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/home/ytka/Python-3.11.10/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/home/ytka/Python-3.11.10/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage '
                            '--title "CPython 3.11 LCOV report [commit $(shell '
                            ')]"',
 'CPPFLAGS': '-I. -I./Include -I/home/ytka/dist/include '
             '-I/home/ytka/dist/include/uuid -I/home/ytka/dist/include/openssl '
             '-L/home/ytka/dist/lib',
 'CXX': 'arm-rockchip830-linux-uclibcgnueabihf-c++',
 ...
 'DESTDIRS': '/home/ytka/dist /home/ytka/dist/lib '
             '/home/ytka/dist/lib/python3.11 '
             '/home/ytka/dist/lib/python3.11/lib-dynload',
 'DESTLIB': '/home/ytka/dist/lib/python3.11',
 'DESTPATH': '',
 'DESTSHARED': '/home/ytka/dist/lib/python3.11/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'HAVE__GETPTY': 0,
 'HOSTRUNNER': '',
 'HOST_GNU_TYPE': 'arm-rockchip830-linux-uclibcgnueabihf',
 'INCLDIRSTOMAKE': '/home/ytka/dist/include /home/ytka/dist/include '
                   '/home/ytka/dist/include/python3.11 '
                   '/home/ytka/dist/include/python3.11',
 'INCLUDEDIR': '/home/ytka/dist/include',
 'INCLUDEPY': '/home/ytka/dist/include/python3.11',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'arm-rockchip830-linux-uclibcgnueabihf-c++ -shared',
 'LDFLAGS': '-L/home/ytka/dist/lib',
 'LDLIBRARY': 'libpython3.11.a',
 'LDLIBRARYDIR': '',
 'LDSHARED': 'arm-rockchip830-linux-uclibcgnueabihf-gcc -shared '
             '-L/home/ytka/dist/lib',
 'LDVERSION': '3.11',
 'LIBC': '',
 'LIBDEST': '/home/ytka/dist/lib/python3.11',
 'LIBDIR': '/home/ytka/dist/lib',
 ...
 'LIBEXPAT_CFLAGS': '-I./Modules/expat -Wsign-compare -DNDEBUG -g -fwrapv -O3 '
                    ...
                    '-I. -I./Include -I/home/ytka/dist/include '
                    '-I/home/ytka/dist/include/uuid '
                    '-I/home/ytka/dist/include/openssl -L/home/ytka/dist/lib '
                    '-fPIC',
 'LIBEXPAT_HEADERS': '\\',
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/home/ytka/dist/lib/pkgconfig',
 'LIBPL': '/home/ytka/dist/lib/python3.11/config-3.11-arm-linux-gnueabihf',
 'LIBPYTHON': '',
 ...
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': 'arm-rockchip830-linux-uclibcgnueabihf-gcc',
 ...
 'LOCALMODLIBS': '-lm -lm Modules/_decimal/libmpdec/libmpdec.a          '
                 '-lm     -lm -lz -lm -lm          -lrt         -lnsl -ltirpc  '
                 '-ldl -lffi  -llzma  -luuid  -lz  -lreadline -ltermlib  '
                 '-L/home/ytka/dist//lib -lssl -lcrypto  '
                 '-L/home/ytka/dist//lib -lcrypto',
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/home/ytka/dist/lib/python3.11',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'arm-rockchip830-linux-uclibcgnueabihf-gcc',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/home/ytka/dist/share/man',
 ...
 'MODBUILT_NAMES': 'atexit  faulthandler  posix  _signal  _tracemalloc  '
                   ...
                   'select  _md5  _sha1  _sha256  _sha512  _sha3  '
                   '_posixsubprocess  _posixshmem  fcntl  grp  ossaudiodev  '
                   'resource  spwd  syslog  termios  nis  _ctypes  _lzma  '
                   '_uuid  zlib  readline  _ssl  _hashlib  xxsubtype',
 'MODDISABLED_NAMES': '',
 'MODLIBS': '-lm -lm Modules/_decimal/libmpdec/libmpdec.a          -lm     -lm '
            '-lz -lm -lm          -lrt         -lnsl -ltirpc  -ldl -lffi  '
            '-llzma  -luuid  -lz  -lreadline -ltermlib  -L/home/ytka/dist//lib '
            '-lssl -lcrypto  -L/home/ytka/dist//lib -lcrypto',
 'MODOBJS': 'Modules/atexitmodule.o  Modules/faulthandler.o  '
            ...
            'Modules/_sha3/sha3module.o  Modules/_posixsubprocess.o  '
 ...
 'MODULE__HASHLIB_CFLAGS': '-I/home/ytka/dist//include',
 'MODULE__HASHLIB_DEPS': './Modules/hashlib.h',
 'MODULE__HASHLIB_LDFLAGS': '-L/home/ytka/dist//lib   -lcrypto',
 ...
 'MODULE__SRE_LDFLAGS': '',
 'MODULE__SSL_CFLAGS': '-I/home/ytka/dist//include',
 ...
 'MODULE__SSL_LDFLAGS': '-L/home/ytka/dist//lib  -lssl -lcrypto',
 ...
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/home/ytka/dist//include',
 'OPENSSL_LDFLAGS': '-L/home/ytka/dist//lib',
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/home/ytka/Python-3.11.10 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/home/ytka/Python-3.11.10/`cat pybuilddir.txt`:)./Lib '
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall '
                             ...
                             '-I./Include -I/home/ytka/dist/include '
                             '-I/home/ytka/dist/include/uuid '
                             '-I/home/ytka/dist/include/openssl '
                             '-L/home/ytka/dist/lib -DPy_BUILD_CORE_BUILTIN',
 ...
 'PY_CORE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall '
                   ...
                   '-I/home/ytka/dist/include/openssl -L/home/ytka/dist/lib '
                   '-DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-L/home/ytka/dist/lib -fno-semantic-interposition -flto '
                    '-fuse-linker-plugin -ffat-lto-objects '
                    '-flto-partition=none -g',
 'PY_CPPFLAGS': '-I. -I./Include -I/home/ytka/dist/include '
                '-I/home/ytka/dist/include/uuid '
                '-I/home/ytka/dist/include/openssl -L/home/ytka/dist/lib',
 'PY_ENABLE_SHARED': 0,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/home/ytka/dist/lib',
 'PY_LDFLAGS_NODIST': '-fno-semantic-interposition -flto -fuse-linker-plugin '
                      '-ffat-lto-objects -flto-partition=none -g',
 'PY_LDFLAGS_NOLTO': '-L/home/ytka/dist/lib -fno-lto',
 ...
 'READELF': 'arm-rockchip830-linux-uclibcgnueabihf-readelf',
 'RESSRCDIR': 'Mac/Resources/framework',
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/home/ytka/dist/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': '_PYTHON_PROJECT_BASE=/home/ytka/Python-3.11.10 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/home/ytka/Python-3.11.10/`cat pybuilddir.txt`:)./Lib '
               '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_arm-linux-gnueabihf '
               'python3.11',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': '_PYTHON_PROJECT_BASE=/home/ytka/Python-3.11.10 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/home/ytka/Python-3.11.10/`cat pybuilddir.txt`:)./Lib '
               '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_arm-linux-gnueabihf '
 ...
 'VERSION': '3.11',
 'WASM_ASSETS_DIR': './home/ytka/dist',
 'WASM_STDLIB': './home/ytka/dist/lib/python3.11/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 0,
 ...
 'abs_builddir': '/home/ytka/Python-3.11.10',
 'abs_srcdir': '/home/ytka/Python-3.11.10',
 'datarootdir': '/home/ytka/dist/share',
 'exec_prefix': '/home/ytka/dist',
 'prefix': '/home/ytka/dist',
 'srcdir': '.'}
